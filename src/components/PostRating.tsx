      ...
      {!hasUserRated && rating > 0 && (
        <div className="py-2">
          <button
            ...
            className="rounded-lg border border-gray-300 py-1.5 text-center text-lg font-semibold hover:bg-secondary hover:text-primary focus:outline-none focus-visible:bg-secondary focus-visible:text-primary focus-visible:ring-2 active:bg-tertiary dark:border-gray-600 md:mr-4 md:px-4"
          >
            {isLoading ? (
