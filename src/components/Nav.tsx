...
const MobileNav: React.FC<{ className: string }> = ({ className }) => {
  ...
  return (
    <Popover className={className}>
      <Popover.Button className="group flex items-center rounded-lg bg-white/90 px-4 py-2 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-primary dark:text-zinc-200 dark:ring-white/10 dark:hover:ring-white/20">
        {i18n.t("nav.menu")}
